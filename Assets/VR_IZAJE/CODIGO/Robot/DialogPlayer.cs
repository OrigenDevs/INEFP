...
public class DialogPlayer : MonoBehaviour
{
    ...
    public float pausaEntrePasos = 2f;

    private int currentIndex;
    private bool reproducirSonidoAlAvanzar = true;
    private DialogData currentDialog;
    private AudioSource audioSource;
    private Coroutine playRoutine;
    private Coroutine avanceRoutine;
    ...
    public void Stop()
    {
        ...
        if (avanceRoutine != null)
        {
            StopCoroutine(avanceRoutine);
            avanceRoutine = null;
        }
    ...
    void FinalizarDialog(DialogData data)
    {
        ...
        reproducirSonidoAlAvanzar = data.sonidoAlAvanzar;
        currentDialog = null;
    ...
    {
        if (dialogList == null || dialogList.Length == 0) return;
        if (avanceRoutine != null) StopCoroutine(avanceRoutine);
        avanceRoutine = StartCoroutine(AvanzarConPausa());
    }

    IEnumerator AvanzarConPausa()
    {
        if (reproducirSonidoAlAvanzar && audioTransicion != null)
